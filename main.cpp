...
void datosExistentes (NodoAsegurados *&listaAsegurados)
{
    FILE *f;
    Asegurados a;
    if(f = fopen("Asegurados.BAK","rb"))
    {
        ...
        {
            insertarOrdenado (listaAsegurados,a);
        }
        fclose(f);
    cout<<endl<< "Se cargaron los datos existentes"<<endl;
    }
    else
    {
        cout<<endl<< "No se encontraron datos existentes."<<endl;
    }
...
char menu(){
    char opcion;
    cout << "0 - Levantar los datos de prueba o levantar datos existentes." <<endl;
...
int main(){
    ...
    do
    {
        ...
        {
        case '0':
            cout<<endl<< "1 - Datos de prueba"<<endl<< "2 - Levantar datos existentes"<<endl;
            do
            {
                opcion2=getch();
            ...
            if (opcion2 == '1')
                ...
                if (opcion2 == '2')
                {
                    datosExistentes(listaAsegurados);
                }
